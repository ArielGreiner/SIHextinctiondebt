  ...
  for(i in 1:length(dispV)){
    ...
    for(j in 1:3){ 
     ...
     Biomass_Time_noreps$Biomass[Biomass_Time_noreps$Rep==r & Biomass_Time_noreps$Dispersal==dispV[i] & Biomass_Time_noreps$Patch_remove==removeV[j] & Biomass_Time_noreps$Species == nSpeciesMult[s] & Biomass_Time_noreps$DelPatches == nPatchDel[p] & Biomass_Time_noreps$Scale=="Local"] <- rowMeans(L_Bmass_sep, na.rm = T)
      ...
      Biomass_Time_noreps$IndivBiomass[Biomass_Time_noreps$Rep==r & Biomass_Time_noreps$Dispersal==dispV[i] & Biomass_Time_noreps$Patch_remove==removeV[j] & Biomass_Time_noreps$Species == nSpeciesMult[s] & Biomass_Time_noreps$DelPatches == nPatchDel[p] & Biomass_Time_noreps$Scale=="Regional"] <- colSums(apply(Abund,3,colSums,na.rm = T))/Biomass_Time_noreps$SR[Biomass_Time_noreps$Rep==r & Biomass_Time_noreps$Dispersal==dispV[i] & Biomass_Time_noreps$Species == nSpecies & Biomass_Time_noreps$DelPatches==nPatchDel[p] & Biomass_Time_noreps$Patch_remove==removeV[j] & Biomass_Time_noreps$Scale=="Regional"]
...
ED_data_noreps$IndivBmassLossNoDel[ED_data_noreps$Rep==r & ED_data_noreps$Dispersal==dispV[i] & ED_data_noreps$Patch_remove==removeV[j] & ED_data_noreps$Species==nSpeciesMult[s] & ED_data_noreps$DelPatches==nPatchDel[p] & ED_data_noreps$Scale=="Regional"] <- (sum(apply(Abund,3,colSums,na.rm = T)[,predel_collecttime])/Biomass_Time_noreps$SR[Biomass_Time_noreps$Rep==r & Biomass_Time_noreps$Dispersal==dispV[i] & Biomass_Time_noreps$Species == nSpecies & Biomass_Time_noreps$DelPatches==nPatchDel[p] & Biomass_Time_noreps$Patch_remove==removeV[j] & Biomass_Time_noreps$Scale=="Regional"][predel_collecttime]) - (sum(apply(Abund[-patch.delete,,],3,colSums,na.rm = T)[,predel_collecttime])/(Biomass_Time_noreps$SR[Biomass_Time_noreps$Rep==r & Biomass_Time_noreps$Dispersal==dispV[i] & Biomass_Time_noreps$Species == nSpecies & Biomass_Time_noreps$DelPatches==nPatchDel[p] & Biomass_Time_noreps$Patch_remove==removeV[j] & Biomass_Time_noreps$Scale=="Regional"][predel_collecttime] - ED_data_noreps$SRLossNoDel[ED_data_noreps$Rep==r & ED_data_noreps$Dispersal==dispV[i] & ED_data_noreps$Patch_remove==removeV[j] & ED_data_noreps$Species==nSpeciesMult[s] & ED_data_noreps$DelPatches==nPatchDel[p] & ED_data_noreps$Scale=="Regional"]))
...
dummy[which(dummy == 0)] <- NA
      ...
      Biomass_Time_noreps$VarIndivBiomass[Biomass_Time_noreps$Rep==r & Biomass_Time_noreps$Dispersal==dispV[i] & Biomass_Time_noreps$Patch_remove==removeV[j] & Biomass_Time_noreps$Species == nSpeciesMult[s] & Biomass_Time_noreps$DelPatches == nPatchDel[p] & Biomass_Time_noreps$Scale=="Regional"] <- apply(dummy,2,var,na.rm=T)
...
ED_data_noreps$VarIndivBmassLossNoDel[ED_data_noreps$Rep==r & ED_data_noreps$Dispersal==dispV[i] & ED_data_noreps$Patch_remove==removeV[j] & ED_data_noreps$Species==nSpeciesMult[s] & ED_data_noreps$DelPatches==nPatchDel[p] & ED_data_noreps$Scale=="Regional"] <- var(dummy[,predel_collecttime], na.rm = T) - var(dummy2[,predel_collecttime], na.rm = T)
      #basically takes the indiv biomass at the time of the patch deletion and subtracts it from the individual biomass that would be if the patches to be deleted were simply not present
      #apply(Abund,3,colSums,na.rm = T)[predel_collecttime] - apply(Abund[-patch.delete,,],3,colSums,na.rm = T)[predel_collecttime] <- changed on 7.5.2016 because it didn't make any sense...
      ...
      ED_data_noreps$IndivBmassLossNoDel[ED_data_noreps$Rep==r & ED_data_noreps$Dispersal==dispV[i] & ED_data_noreps$Patch_remove==removeV[j] & ED_data_noreps$Species==nSpeciesMult[s] & ED_data_noreps$DelPatches==nPatchDel[p] & ED_data_noreps$Scale=="Local"] <- colMeans(localibiomass,na.rm=T)[predel_collecttime] - colMeans(localibiomass[-patch.delete,],na.rm=T)[predel_collecttime]
      
      Biomass_Time_noreps$VarIndivBiomass[Biomass_Time_noreps$Rep==r & Biomass_Time_noreps$Dispersal==dispV[i] & Biomass_Time_noreps$Patch_remove==removeV[j] & Biomass_Time_noreps$Species == nSpeciesMult[s] & Biomass_Time_noreps$DelPatches == nPatchDel[p] & Biomass_Time_noreps$Scale=="Local"] <- colMeans(varlocalibiomass,na.rm=T)
      
      ED_data_noreps$VarIndivBmassLossNoDel[ED_data_noreps$Rep==r & ED_data_noreps$Dispersal==dispV[i] & ED_data_noreps$Patch_remove==removeV[j] & ED_data_noreps$Species==nSpeciesMult[s] & ED_data_noreps$DelPatches==nPatchDel[p] & ED_data_noreps$Scale=="Local"] <- colMeans(varlocalibiomass,na.rm=T)[predel_collecttime] - colMeans(varlocalibiomass[-patch.delete,],na.rm=T)[predel_collecttime]
...
PropBiomass_Time_noreps$Biomass[PropBiomass_Time_noreps$Rep==r & PropBiomass_Time_noreps$Dispersal==dispV[i] & PropBiomass_Time_noreps$Patch_remove==removeV[j] & PropBiomass_Time_noreps$Species == nSpeciesMult[s] & PropBiomass_Time_noreps$DelPatches == nPatchDel[p] & PropBiomass_Time_noreps$Scale=="Regional"] <- R_Bmass/Biomass_Time_noreps$Biomass[Biomass_Time_noreps$Rep==r & Biomass_Time_noreps$Dispersal==dispV[i] & Biomass_Time_noreps$Patch_remove==removeV[j] & Biomass_Time_noreps$Species == nSpeciesMult[s] & Biomass_Time_noreps$DelPatches == nPatchDel[p] & Biomass_Time_noreps$Scale=="Regional"][predel_collecttime] 
      ...
      PropBiomass_Time_noreps$IndivBiomass[PropBiomass_Time_noreps$Rep==r & PropBiomass_Time_noreps$Dispersal==dispV[i] & PropBiomass_Time_noreps$Patch_remove==removeV[j] & PropBiomass_Time_noreps$Species == nSpeciesMult[s] & PropBiomass_Time_noreps$DelPatches == nPatchDel[p] & PropBiomass_Time_noreps$Scale=="Regional"] <- Biomass_Time_noreps$IndivBiomass[Biomass_Time_noreps$Rep==r & Biomass_Time_noreps$Dispersal==dispV[i] & Biomass_Time_noreps$Patch_remove==removeV[j] & Biomass_Time_noreps$Species == nSpeciesMult[s] & Biomass_Time_noreps$DelPatches == nPatchDel[p] & Biomass_Time_noreps$Scale=="Regional"]/Biomass_Time_noreps$IndivBiomass[Biomass_Time_noreps$Rep==r & Biomass_Time_noreps$Dispersal==dispV[i] & Biomass_Time_noreps$Patch_remove==removeV[j] & Biomass_Time_noreps$Species == nSpeciesMult[s] & Biomass_Time_noreps$DelPatches == nPatchDel[p] & Biomass_Time_noreps$Scale=="Regional"][predel_collecttime]
      ...
      #colMeans(apply(Abund,3,colSums,na.rm = T))/Biomass_Time_noreps$IndivBiomass[Biomass_Time_noreps$Rep==r & Biomass_Time_noreps$Dispersal==dispV[i] & Biomass_Time_noreps$Patch_remove==removeV[j] & Biomass_Time_noreps$Species == nSpeciesMult[s] & Biomass_Time_noreps$DelPatches == nPatchDel[p] & Biomass_Time_noreps$Scale=="Regional"][predel_collecttime]
            ...
            PropBiomass_Time_noreps$IndivBiomass[PropBiomass_Time_noreps$Rep==r & PropBiomass_Time_noreps$Dispersal==dispV[i] & PropBiomass_Time_noreps$Patch_remove==removeV[j] & PropBiomass_Time_noreps$Species == nSpeciesMult[s] & PropBiomass_Time_noreps$DelPatches == nPatchDel[p] & PropBiomass_Time_noreps$Scale=="Local"] <- Biomass_Time_noreps$IndivBiomass[Biomass_Time_noreps$Rep==r & Biomass_Time_noreps$Dispersal==dispV[i] & Biomass_Time_noreps$Patch_remove==removeV[j] & Biomass_Time_noreps$Species == nSpeciesMult[s] & Biomass_Time_noreps$DelPatches == nPatchDel[p] & Biomass_Time_noreps$Scale=="Local"]/Biomass_Time_noreps$IndivBiomass[Biomass_Time_noreps$Rep==r & Biomass_Time_noreps$Dispersal==dispV[i] & Biomass_Time_noreps$Patch_remove==removeV[j] & Biomass_Time_noreps$Species == nSpeciesMult[s] & Biomass_Time_noreps$DelPatches == nPatchDel[p] & Biomass_Time_noreps$Scale=="Local"][predel_collecttime]
...
PercentBiomass_Time_noreps$Biomass[PercentBiomass_Time_noreps$Rep==r & PercentBiomass_Time_noreps$Dispersal==dispV[i] & PercentBiomass_Time_noreps$Patch_remove==removeV[j] & PercentBiomass_Time_noreps$Species == nSpeciesMult[s] & PercentBiomass_Time_noreps$DelPatches == nPatchDel[p] & PercentBiomass_Time_noreps$Scale=="Regional"] <- abs((R_Bmass[predel_collecttime] - R_Bmass)/(R_Bmass[predel_collecttime])) 
      ...
      PercentBiomass_Time_noreps$IndivBiomass[PercentBiomass_Time_noreps$Rep==r & PercentBiomass_Time_noreps$Dispersal==dispV[i] & PercentBiomass_Time_noreps$Patch_remove==removeV[j] & PercentBiomass_Time_noreps$Species == nSpeciesMult[s] & PercentBiomass_Time_noreps$DelPatches == nPatchDel[p] & PercentBiomass_Time_noreps$Scale=="Regional"] <- abs((Biomass_Time_noreps$IndivBiomass[Biomass_Time_noreps$Rep==r & Biomass_Time_noreps$Dispersal==dispV[i] & Biomass_Time_noreps$Patch_remove==removeV[j] & Biomass_Time_noreps$Species == nSpeciesMult[s] & Biomass_Time_noreps$DelPatches == nPatchDel[p] & Biomass_Time_noreps$Scale=="Regional"][predel_collecttime] - Biomass_Time_noreps$IndivBiomass[Biomass_Time_noreps$Rep==r & Biomass_Time_noreps$Dispersal==dispV[i] & Biomass_Time_noreps$Patch_remove==removeV[j] & Biomass_Time_noreps$Species == nSpeciesMult[s] & Biomass_Time_noreps$DelPatches == nPatchDel[p] & Biomass_Time_noreps$Scale=="Regional"])/(Biomass_Time_noreps$IndivBiomass[Biomass_Time_noreps$Rep==r & Biomass_Time_noreps$Dispersal==dispV[i] & Biomass_Time_noreps$Patch_remove==removeV[j] & Biomass_Time_noreps$Species == nSpeciesMult[s] & Biomass_Time_noreps$DelPatches == nPatchDel[p] & Biomass_Time_noreps$Scale=="Regional"][predel_collecttime]))
      #abs((colMeans(apply(Abund,3,colSums,na.rm = T))[predel_collecttime] - colMeans(apply(Abund,3,colSums,na.rm = T)))/(colMeans(apply(Abund,3,colSums,na.rm = T))[predel_collecttime]))
            ...
            PercentBiomass_Time_noreps$IndivBiomass[PercentBiomass_Time_noreps$Rep==r & PercentBiomass_Time_noreps$Dispersal==dispV[i] & PercentBiomass_Time_noreps$Patch_remove==removeV[j] & PercentBiomass_Time_noreps$Species == nSpeciesMult[s] & PercentBiomass_Time_noreps$DelPatches == nPatchDel[p] & PercentBiomass_Time_noreps$Scale=="Local"] <- abs((Biomass_Time_noreps$IndivBiomass[Biomass_Time_noreps$Rep==r & Biomass_Time_noreps$Dispersal==dispV[i] & Biomass_Time_noreps$Patch_remove==removeV[j] & Biomass_Time_noreps$Species == nSpeciesMult[s] & Biomass_Time_noreps$DelPatches == nPatchDel[p] & Biomass_Time_noreps$Scale=="Local"][predel_collecttime] - Biomass_Time_noreps$IndivBiomass[Biomass_Time_noreps$Rep==r & Biomass_Time_noreps$Dispersal==dispV[i] & Biomass_Time_noreps$Patch_remove==removeV[j] & Biomass_Time_noreps$Species == nSpeciesMult[s] & Biomass_Time_noreps$DelPatches == nPatchDel[p] & Biomass_Time_noreps$Scale=="Local"])/(Biomass_Time_noreps$IndivBiomass[Biomass_Time_noreps$Rep==r & Biomass_Time_noreps$Dispersal==dispV[i] & Biomass_Time_noreps$Patch_remove==removeV[j] & Biomass_Time_noreps$Species == nSpeciesMult[s] & Biomass_Time_noreps$DelPatches == nPatchDel[p] & Biomass_Time_noreps$Scale=="Local"][predel_collecttime]))
...
for(w in 1:nSpecies){
	...
	SpeciesBiomass_Time_noreps$Biomass[SpeciesBiomass_Time_noreps$Rep==r & SpeciesBiomass_Time_noreps$Dispersal==dispV[i] & SpeciesBiomass_Time_noreps$Patch_remove==removeV[j] & SpeciesBiomass_Time_noreps$DelPatches == nPatchDel[p] & SpeciesBiomass_Time_noreps$Scale=="Local" & SpeciesBiomass_Time_noreps$Species == w] <- colMeans(Abund[,w,], na.rm=T)

SpeciesBiomass_Time_noreps$Biomass[SpeciesBiomass_Time_noreps$Rep==r & SpeciesBiomass_Time_noreps$Dispersal==dispV[i] & SpeciesBiomass_Time_noreps$Patch_remove==removeV[j] & SpeciesBiomass_Time_noreps$DelPatches == nPatchDel[p] & SpeciesBiomass_Time_noreps$Scale=="Regional" & SpeciesBiomass_Time_noreps$Species == w] <- colSums(Abund[,w,], na.rm=T)

SpeciesBiomass_Time_noreps$Biomass[SpeciesBiomass_Time_noreps$Rep==r & SpeciesBiomass_Time_noreps$Dispersal==dispV[i] & SpeciesBiomass_Time_noreps$Patch_remove==removeV[j] & SpeciesBiomass_Time_noreps$DelPatches == nPatchDel[p] & SpeciesBiomass_Time_noreps$Scale=="Patch A" & SpeciesBiomass_Time_noreps$Species == w] <- Abund[patches[1],w,]

SpeciesBiomass_Time_noreps$Biomass[SpeciesBiomass_Time_noreps$Rep==r & SpeciesBiomass_Time_noreps$Dispersal==dispV[i] & SpeciesBiomass_Time_noreps$Patch_remove==removeV[j] & SpeciesBiomass_Time_noreps$DelPatches == nPatchDel[p] & SpeciesBiomass_Time_noreps$Scale=="Patch B" & SpeciesBiomass_Time_noreps$Species == w] <- Abund[patches[2],w,]
