...
Numpredel <- Biomass_Time_noreps$SR[Biomass_Time_noreps$Scale == "Regional" & Biomass_Time_noreps$Dispersal == dispV[i] & Biomass_Time_noreps$Patch_remove == removeV[w] & Biomass_Time_noreps$Species == nSpeciesMult[s] & Biomass_Time_noreps$DelPatches == nPatchDel[p] & Biomass_Time_noreps$Rep == r][predel_collecttime]
          Biomasspredel <- Biomass_Time_noreps$Biomass[Biomass_Time_noreps$Scale == "Regional" & Biomass_Time_noreps$Dispersal == dispV[i] & Biomass_Time_noreps$Patch_remove == removeV[w] & Biomass_Time_noreps$Species == nSpeciesMult[s] & Biomass_Time_noreps$DelPatches == nPatchDel[p] & Biomass_Time_noreps$Rep == r][predel_collecttime]
          CVpredel <- Biomass_Time_noreps$CVTime[Biomass_Time_noreps$Scale == "Regional" & Biomass_Time_noreps$Dispersal == dispV[i] & Biomass_Time_noreps$Patch_remove == removeV[w] & Biomass_Time_noreps$Species == nSpeciesMult[s] & Biomass_Time_noreps$DelPatches == nPatchDel[p] & Biomass_Time_noreps$Rep == r][predel_collecttime]
          
          ED_data_noreps$PercentLoss[ED_data_noreps$Scale == "Regional" & ED_data_noreps$Dispersal == dispV[i] & ED_data_noreps$Patch_remove == removeV[w] & ED_data_noreps$Species == nSpeciesMult[s] & ED_data_noreps$DelPatches == nPatchDel[p] & ED_data_noreps$Rep == r]<- (Numpredel - Biomass_Time_noreps$SR[Biomass_Time_noreps$Scale == "Regional" & Biomass_Time_noreps$Dispersal == dispV[i] & Biomass_Time_noreps$Patch_remove == removeV[w] & Biomass_Time_noreps$Species == nSpeciesMult[s] & Biomass_Time_noreps$DelPatches == nPatchDel[p] & Biomass_Time_noreps$Rep == r][length(sampleV)])/Numpredel
...
#Percentage Versions of Biomass_Time Metrics
    PercentBiomass_Time_noreps$Biomass[PercentBiomass_Time_noreps$Rep==r & PercentBiomass_Time_noreps$Dispersal==dispV[i] & PercentBiomass_Time_noreps$Patch_remove==removeV[j] & PercentBiomass_Time_noreps$Species == nSpeciesMult[s] & PercentBiomass_Time_noreps$DelPatches == nPatchDel[p] & PercentBiomass_Time_noreps$Scale=="Local"] <- rowMeans(L_Bmass_sep, na.rm = T)/Biomass_Time_noreps$Biomass[Biomass_Time_noreps$Rep==r & Biomass_Time_noreps$Dispersal==dispV[i] & Biomass_Time_noreps$Patch_remove==removeV[j] & Biomass_Time_noreps$Species == nSpeciesMult[s] & Biomass_Time_noreps$DelPatches == nPatchDel[p] & Biomass_Time_noreps$Scale=="Local"][predel_collecttime]
...
PercentBiomass_Time_noreps$Biomass[PercentBiomass_Time_noreps$Rep==r & PercentBiomass_Time_noreps$Dispersal==dispV[i] & PercentBiomass_Time_noreps$Patch_remove==removeV[j] & PercentBiomass_Time_noreps$Species == nSpeciesMult[s] & PercentBiomass_Time_noreps$DelPatches == nPatchDel[p] & PercentBiomass_Time_noreps$Scale=="Regional"] <- abs((R_Bmass[predel_collecttime] - R_Bmass)/(R_Bmass[predel_collecttime])) 
      ...
      PercentBiomass_Time_noreps$IndivBiomass[PercentBiomass_Time_noreps$Rep==r & PercentBiomass_Time_noreps$Dispersal==dispV[i] & PercentBiomass_Time_noreps$Patch_remove==removeV[j] & PercentBiomass_Time_noreps$Species == nSpeciesMult[s] & PercentBiomass_Time_noreps$DelPatches == nPatchDel[p] & PercentBiomass_Time_noreps$Scale=="Regional"] <- abs((colMeans(apply(Abund,3,colSums,na.rm = T))[predel_collecttime] - colMeans(apply(Abund,3,colSums,na.rm = T)))/(colMeans(apply(Abund,3,colSums,na.rm = T))[predel_collecttime]))
            ...
            PercentBiomass_Time_noreps$IndivBiomass[PercentBiomass_Time_noreps$Rep==r & PercentBiomass_Time_noreps$Dispersal==dispV[i] & PercentBiomass_Time_noreps$Patch_remove==removeV[j] & PercentBiomass_Time_noreps$Species == nSpeciesMult[s] & PercentBiomass_Time_noreps$DelPatches == nPatchDel[p] & PercentBiomass_Time_noreps$Scale=="Local"] <- (colMeans(localibiomass,na.rm=T)[predel_collecttime] - colMeans(localibiomass,na.rm=T))/(colMeans(localibiomass,na.rm=T)[predel_collecttime])
